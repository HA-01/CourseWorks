...
public class VaccinationCenter extends Writer {
    ...
    static Booth[] boothObjects = new Booth[6];                              //instatiating an array of Booth class
    ...
    private static String typeOfVacciine;
    ...
    public static LinkedList<Booth> WaitingListAstraZeneca = new LinkedList<Booth>();              //linked list initializing according to vaccine type
    public static LinkedList<Booth> WaitingListSinopharm = new LinkedList<Booth>();
    public static LinkedList<Booth> WaitingListPfizer = new LinkedList<Booth>();
    ...
    public static void main(String args[]) {
        boolean finished = true;                                   //boolean flag of main method
        initialise();
        ...
        do {
            ...
            switch (option) {
                ...
                case "999":
                case "EXT":
                    finished = false;                                   //boolean flag set to false
    ...
    public static void initialise() {                                                 //iinitializing booth objects
        for (int x = 0; x < 6; x++)
    ...
    public static void validateBoothNumEntered() {
        boolean flagValidation = true;                                         //boolean flag validation
    ...
    public static void ViewAllVaccinationBooths() {
        ...
        for (i = 0; i < 6; i++) {
            if (boothObjects[i].getFirstName().equals("e")) {
                ...
                numberOfPatients = numberOfPatients + 1;                                      //updating number of patients
            }
    ...
    public static void ViewAllEmptyBooths() {
        int i;
        for (i = 0; i < 6; i++) {
            if (boothObjects[i].getFirstName().equals(" ")) {
                System.out.println("Booth number " + i + " is empty.");
            }
        }
    }
    ...
    public static void AddPatientToABooth() {
        ...
        try {
            if (vaccineType.equals("A")) {
                ...
                System.out.println("All booths are filled.Added to waiting list.");
    ...
    public static void addtobooth(int i)                                    //method to add patient details
    {
    ...
    @Override
    public void write(char[] cbuf, int off, int len) throws IOException {                             //over riding three methods fo file handling
